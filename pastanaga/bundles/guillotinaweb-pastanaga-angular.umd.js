(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('rxjs'), require('date-fns'), require('@angular/common'), require('@angular/router'), require('@angular/cdk/coercion'), require('@angular/common/http'), require('angular-svg-icon'), require('angular-traversal'), require('@angular/forms'), require('rxjs/operators'), require('@angular/cdk/platform'), require('@angular/cdk/text-field'), require('@angular/animations')) :
    typeof define === 'function' && define.amd ? define('@guillotinaweb/pastanaga-angular', ['exports', '@angular/core', 'rxjs', 'date-fns', '@angular/common', '@angular/router', '@angular/cdk/coercion', '@angular/common/http', 'angular-svg-icon', 'angular-traversal', '@angular/forms', 'rxjs/operators', '@angular/cdk/platform', '@angular/cdk/text-field', '@angular/animations'], factory) :
    (global = global || self, factory((global.guillotinaweb = global.guillotinaweb || {}, global.guillotinaweb['pastanaga-angular'] = {}), global.ng.core, global.rxjs, global.dateFns, global.ng.common, global.ng.router, global.ng.cdk.coercion, global.ng.common.http, global.angularSvgIcon, global.angularTraversal, global.ng.forms, global.rxjs.operators, global.ng.cdk.platform, global.ng.cdk['text-field'], global.ng.animations));
}(this, (function (exports, core, rxjs, dateFns, common, router, coercion, http, angularSvgIcon, angularTraversal, forms, operators, platform, textField, animations) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var SidebarService = /** @class */ (function () {
        ...
        SidebarService.ɵprov = core["ɵɵdefineInjectable"]({ factory: function SidebarService_Factory() { return new SidebarService(); }, token: SidebarService, providedIn: "root" });
    ...
    var TranslatePipe = /** @class */ (function () {
        ...
        TranslatePipe.ctorParameters = function () { return [
            { type: undefined, decorators: [{ type: core.Inject, args: ['LANG',] }] },
        ...
        TranslatePipe = __decorate([
            ...
            __param(0, core.Inject('LANG')),
            __param(1, core.Inject('TRANSLATIONS')),
    ...
    var PopupService = /** @class */ (function () {
        function PopupService() {
            this.closeAllPopups = new rxjs.Subject();
            this.closeAllButId = new rxjs.Subject();
            this.closeAllSubMenu = new rxjs.Subject();
        }
        PopupService.ɵprov = core["ɵɵdefineInjectable"]({ factory: function PopupService_Factory() { return new PopupService(); }, token: PopupService, providedIn: "root" });
    ...
    var CalendarService = /** @class */ (function () {
        ...
        CalendarService.prototype.getNextMonth = function (date, selectedRange, min) {
            var nextDate = dateFns.addMonths(date, 1);
        ...
        CalendarService.prototype.getPreviousMonth = function (date, selectedRange, min) {
            var previousDate = dateFns.subMonths(date, 1);
        ...
        CalendarService.prototype.getMonth = function (date, selectedRange, min) {
            ...
            var dateRef = start;
            if (!dateFns.isSunday(start)) {
                start = dateFns.startOfWeek(start);
            }
            if (!dateFns.isSaturday(end)) {
                end = dateFns.endOfWeek(end);
            }
            return {
                dateRef: dateRef,
                dates: dateFns.eachDayOfInterval({ start: start, end: end }).map(function (d) { return new CalendarDate({
                    date: d,
                    label: "" + d.getDate(),
                    isFuture: dateFns.isFuture(d),
                    firstOfInterval: !!selectedRange.start && dateFns.isSameDay(d, selectedRange.start),
                    lastOfInterval: !!selectedRange.end && dateFns.isSameDay(d, selectedRange.end),
                    inInterval: !!selectedRange.start && !!selectedRange.end
                        && dateFns.isWithinInterval(d, { start: selectedRange.start, end: selectedRange.end }),
                    isActive: (!!selectedRange.start && dateFns.isSameDay(d, selectedRange.start))
                        || (!!selectedRange.end && dateFns.isSameDay(d, selectedRange.end)),
                    isDisabled: !!min && dateFns.isBefore(d, min),
                }); }),
                headerButtons: [
                    { label: dateFns.format(date, 'MMMM'), view: exports.CalendarView.month },
                    { label: dateFns.format(date, 'yyyy'), view: exports.CalendarView.year },
                ],
            };
        };
        CalendarService.prototype.getPreviousMonths = function (date, currentDate, min) {
            var previousDate = dateFns.subYears(date, 1);
            return this.getMonths(previousDate, currentDate, min);
        };
        CalendarService.prototype.getNextMonths = function (date, currentDate, min) {
            var nextDate = dateFns.addYears(date, 1);
            return this.getMonths(nextDate, currentDate, min);
        };
        CalendarService.prototype.getMonths = function (date, currentDate, min) {
            var start = dateFns.startOfYear(date);
            var end = dateFns.endOfYear(date);
            return {
                dateRef: start,
                dates: dateFns.eachMonthOfInterval({ start: start, end: end }).map(function (d) { return new CalendarDate({
                    date: d,
                    label: dateFns.format(d, 'MMMM'),
                    isFuture: dateFns.isFuture(d),
                    isActive: dateFns.isSameMonth(d, currentDate),
                    isDisabled: !!min && !dateFns.isSameMonth(d, min) && dateFns.isBefore(d, min),
                }); }),
                headerButtons: [{ label: dateFns.format(date, 'yyyy'), view: exports.CalendarView.year }],
            };
        };
        CalendarService.prototype.getPreviousYears = function (date, currentDate, min) {
            var previousDate = dateFns.subYears(date, 20);
            return this.getYears(previousDate, currentDate, min);
        };
        CalendarService.prototype.getNextYears = function (date, currentDate, min) {
            var nextDate = dateFns.addYears(date, 20);
            return this.getYears(nextDate, currentDate, min);
        };
        CalendarService.prototype.getYears = function (date, currentDate, min) {
            var start = dateFns.subYears(date, 10);
            var end = dateFns.addYears(date, 9);
            return {
                dateRef: date,
                dates: dateFns.eachYearOfInterval({ start: start, end: end }).map(function (d) { return new CalendarDate({
                    date: d,
                    label: "" + d.getFullYear(),
                    isFuture: dateFns.isFuture(d),
                    isActive: dateFns.isSameYear(d, currentDate),
                    isDisabled: !!min && !dateFns.isSameYear(d, min) && dateFns.isBefore(d, min),
                }); }),
                headerButtons: [{ label: start.getFullYear() + " - " + end.getFullYear(), view: exports.CalendarView.day }],
            };
        };
        CalendarService.ɵprov = core["ɵɵdefineInjectable"]({ factory: function CalendarService_Factory() { return new CalendarService(); }, token: CalendarService, providedIn: "root" });
    ...
    var PastanagaService = /** @class */ (function () {
        ...
        PastanagaService.ɵprov = core["ɵɵdefineInjectable"]({ factory: function PastanagaService_Factory() { return new PastanagaService(core["ɵɵinject"](CalendarService), core["ɵɵinject"](PopupService), core["ɵɵinject"](SidebarService), core["ɵɵinject"](TranslatePipe)); }, token: PastanagaService, providedIn: "root" });
    ...
    var ButtonBase = /** @class */ (function () {
        function ButtonBase(changeDetector) {
            ...
            this.hasFocus = new core.EventEmitter();
        ...
        Object.defineProperty(ButtonBase.prototype, "border", {
            set: function (value) {
                this.buttonStyle['pa-button-accent'] = coercion.coerceBooleanProperty(value);
            },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(ButtonBase.prototype, "disabled", {
            set: function (value) {
                this.isDisabled = coercion.coerceBooleanProperty(value);
            },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(ButtonBase.prototype, "active", {
            set: function (value) {
                this.buttonStyle['active'] = coercion.coerceBooleanProperty(value);
            },
            enumerable: true,
            configurable: true
        });
        ...
        Object.defineProperty(ButtonBase.prototype, "iconAndText", {
            ...
            set: function (value) {
                this._iconAndText = coercion.coerceBooleanProperty(value);
            },
            enumerable: true,
            configurable: true
        });
    ...
    var ButtonComponent = /** @class */ (function (_super) {
        ...
        ButtonComponent = __decorate([
            core.Component({
                ...
                changeDetection: core.ChangeDetectionStrategy.OnPush,
                encapsulation: core.ViewEncapsulation.None // to allow button style to access icon svg
            }),
            __metadata("design:paramtypes", [core.ChangeDetectorRef])
        ], ButtonComponent);
    ...
    var ButtonLinkComponent = /** @class */ (function (_super) {
        ...
        Object.defineProperty(ButtonLinkComponent.prototype, "hasButtonDisplay", {
            set: function (value) {
                this.buttonStyle['pa-button-link'] = !coercion.coerceBooleanProperty(value);
            },
            enumerable: true,
            configurable: true
        });
    ...
    var Icon = /** @class */ (function () {
        function Icon(data) {
            ...
            this.size = data.size || exports.IconSize.MEDIUM;
        }
        return Icon;
    }());
    ...
    var IconComponent = /** @class */ (function () {
        ...
        Object.defineProperty(IconComponent.prototype, "icon", {
            set: function (value) {
                if (!!value) {
                    ...
                    this._medium = value.size === exports.IconSize.MEDIUM;
                    this._small = value.size === exports.IconSize.SMALL;
                    this._large = value.size === exports.IconSize.LARGE;
        ...
        Object.defineProperty(IconComponent.prototype, "hidden", {
            ...
            set: function (value) {
                this._hidden = coercion.coerceBooleanProperty(value);
                this.updateSvg();
            },
            enumerable: true,
            configurable: true
        ...
        IconComponent = __decorate([
            ...
            __metadata("design:paramtypes", [core.ElementRef,
                core.Renderer2,
                angularSvgIcon.SvgIconRegistryService,
                SvgLoader,
                Object])
        ], IconComponent);
    ...
    var SvgModule = /** @class */ (function () {
        ...
        SvgModule = __decorate([
            core.NgModule({
                imports: [common.CommonModule, http.HttpClientModule, angularSvgIcon.AngularSvgIconModule],
        ...
        ButtonModule = __decorate([
            core.NgModule({
                imports: [
                    ...
                    SvgModule,
                    router.RouterModule,
                    angularTraversal.TraversalModule,
                ],
    ...
    var TooltipDirective = /** @class */ (function () {
        ...
        Object.defineProperty(TooltipDirective.prototype, "paTooltipOffset", {
            ...
            set: function (value) { this.offset = coercion.coerceNumberProperty(value); },
            enumerable: true,
            configurable: true
        });
        ...
        __decorate([
            core.Input('paTooltip'),
            __metadata("design:type", Object)
        ], TooltipDirective.prototype, "text", void 0);
        __decorate([
            core.Input('paTooltipType'),
            __metadata("design:type", String)
    ...
    var TooltipModule = /** @class */ (function () {
        ...
        TooltipModule = __decorate([
            core.NgModule({
                imports: [common.CommonModule, TranslateModule],
    ...
    var AvatarComponent = /** @class */ (function () {
        ...
        Object.defineProperty(AvatarComponent.prototype, "isButton", {
            set: function (value) { this._isButton = coercion.coerceBooleanProperty(value); },
            enumerable: true,
            configurable: true
        });
    ...
    var CheckboxComponent = /** @class */ (function () {
        ...
        Object.defineProperty(CheckboxComponent.prototype, "indeterminate", {
            set: function (value) { this._indeterminate = coercion.coerceBooleanProperty(value); },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(CheckboxComponent.prototype, "labelHidden", {
            set: function (value) { this._labelHidden = coercion.coerceBooleanProperty(value); },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(CheckboxComponent.prototype, "noFocus", {
            set: function (value) { this._noFocus = coercion.coerceBooleanProperty(value); },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(CheckboxComponent.prototype, "squareCheck", {
            set: function (value) { this._squareCheck = coercion.coerceBooleanProperty(value); },
            enumerable: true,
            configurable: true
        });
        ...
        __decorate([
            core.ViewChild('ellipsisText', { static: true }),
            __metadata("design:type", core.ElementRef)
    ...
    })(exports.CheckboxTreeMode || (exports.CheckboxTreeMode = {}));
    var CheckboxTreeComponent = /** @class */ (function () {
        function CheckboxTreeComponent(translate, cdr) {
             ...
             */
            this.mode = exports.CheckboxTreeMode.categorized;
            // not meant to be used outside
            this._isChildren = false;
            this.selection = new core.EventEmitter();
            this.childrenSelection = new core.EventEmitter();
            this.allSelected = new core.EventEmitter();
            this.updatedTree = new core.EventEmitter();
            this.isLoadingChildren = new core.EventEmitter();
            this._checkboxes = [];
            ...
            this._disabled = false;
            this.modes = exports.CheckboxTreeMode;
            this.isAllSelected = false;
            this.isAsync = false;
            this.totalCount = 0;
        ...
        Object.defineProperty(CheckboxTreeComponent.prototype, "shouldSort", {
            set: function (value) { this._shouldSort = coercion.coerceBooleanProperty(value); },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(CheckboxTreeComponent.prototype, "badgeVisible", {
            set: function (value) { this._badgeVisible = coercion.coerceBooleanProperty(value); },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(CheckboxTreeComponent.prototype, "selectAllVisible", {
            set: function (value) { this._selectAllVisible = coercion.coerceBooleanProperty(value); },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(CheckboxTreeComponent.prototype, "countVisible", {
            set: function (value) {
                this._countVisible = coercion.coerceBooleanProperty(value);
        ...
        CheckboxTreeComponent.prototype.toggleSelection = function (isSelected, checkbox) {
            ...
            var shouldUpdateChildren = !!checkbox.children && (isSelected || this.mode !== exports.CheckboxTreeMode.fileSystem);
            ...
            checkbox.isIndeterminate = this.mode !== exports.CheckboxTreeMode.fileSystem ? false : this.getIndeterminateForFileSystem(checkbox);
            this.updateAllSelected();
            this.emitSelectionChanged();
        };
        ...
        CheckboxTreeComponent.prototype.setParentState = function (childrenTree, parent) {
            ...
            if (this.mode === exports.CheckboxTreeMode.fileSystem) {
        ...
        CheckboxTreeComponent.prototype.updateSelectedValues = function (checkbox, selectedValues) {
            ...
            var isCategorized = this.mode === exports.CheckboxTreeMode.categorized;
        ...
        CheckboxTreeComponent.prototype.loadChildren = function () {
            ...
            if (this.isAsync && !!this.getChildren && !this._isLoadingChildren) {
                ...
                var _loop_1 = function (checkbox) {
                    ...
                    requests.push(this_1.getChildren(checkbox).pipe(operators.tap(function (children) {
                    ...
                    _this.checkboxComponents.forEach(function (checkboxComponent) {
                        ...
                        if (!!checkbox && !!checkbox.totalChildren) {
                            ...
                            if (!!badge) {
                                ...
                                var extraWidth = _this.mode === exports.CheckboxTreeMode.fileSystem ? badgeWidth + 124 : badgeWidth;
        ...
        __decorate([
            core.ViewChildren(CheckboxComponent),
            __metadata("design:type", core.QueryList)
        ], CheckboxTreeComponent.prototype, "checkboxComponents", void 0);
        __decorate([
            core.ViewChildren(BadgeComponent),
            __metadata("design:type", core.QueryList)
        ...
        CheckboxTreeComponent = CheckboxTreeComponent_1 = __decorate([
            core.Component({
                ...
                providers: [{
                        ...
                        useExisting: core.forwardRef(function () { return CheckboxTreeComponent_1; }),
                        multi: true,
                    }],
                changeDetection: core.ChangeDetectionStrategy.OnPush,
    ...
    var CheckboxGroupComponent = /** @class */ (function () {
        ...
        Object.defineProperty(CheckboxGroupComponent.prototype, "countVisible", {
            set: function (value) { this._countVisible = coercion.coerceBooleanProperty(value); },
            enumerable: true,
            configurable: true
        });
    ...
    var PastanagaSpinnerComponent = /** @class */ (function () {
        ...
        Object.defineProperty(PastanagaSpinnerComponent.prototype, "small", {
            get: function () { return this._small; },
            set: function (value) { this._small = coercion.coerceBooleanProperty(value); },
            enumerable: true,
            configurable: true
        });
    ...
    var PastanagaProgressCircleComponent = /** @class */ (function () {
        ...
        Object.defineProperty(PastanagaProgressCircleComponent.prototype, "percent", {
            set: function (value) {
                this.percentValue = Math.min(Math.ceil(coercion.coerceNumberProperty(value)), 100);
            },
            enumerable: true,
            configurable: true
        });
    ...
    var TextfieldCommon = /** @class */ (function () {
        function TextfieldCommon() {
            ...
            this.valueChange = new core.EventEmitter();
            this.instantValueChange = new core.EventEmitter();
            ...
            this.terminator = new rxjs.Subject();
            this.debouncer.pipe(operators.takeUntil(this.terminator), operators.debounceTime(this.debounceDuration)).subscribe(function (value) { return _this.valueChange.emit(value); });
        }
        ...
        Object.defineProperty(TextfieldCommon.prototype, "isPlaceholderShown", {
            ...
            set: function (value) { this._placeholderShown = coercion.coerceBooleanProperty(value); },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(TextfieldCommon.prototype, "isLessen", {
            get: function () { return this._isLessen; },
            set: function (value) { this._isLessen = coercion.coerceBooleanProperty(value); },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(TextfieldCommon.prototype, "accent", {
            get: function () { return this._accent; },
            set: function (value) { this._accent = coercion.coerceBooleanProperty(value); },
            enumerable: true,
            configurable: true
        });
    ...
    var InputComponent = /** @class */ (function (_super) {
        ...
        __decorate([
            core.ViewChild('dataInput', { static: true }),
            __metadata("design:type", core.ElementRef)
        ...
        InputComponent = InputComponent_1 = __decorate([
            core.Component({
                ...
                providers: [
                    {
                        provide: forms.NG_VALUE_ACCESSOR,
                        useExisting: core.forwardRef(function () { return InputComponent_1; }),
                        multi: true,
                    },
                    {
    ...
    var SelectComponent = /** @class */ (function () {
        ...
        SelectComponent = SelectComponent_1 = __decorate([
            core.Component({
                ...
                providers: [{
                        provide: forms.NG_VALUE_ACCESSOR,
                        useExisting: core.forwardRef(function () { return SelectComponent_1; }),
                        multi: true,
                    }, {
                        provide: forms.NG_VALIDATORS,
                        useExisting: core.forwardRef(function () { return SelectComponent_1; }),
    ...
    var TextareaComponent = /** @class */ (function (_super) {
        ...
        function TextareaComponent(renderer) {
            ...
            _this.keyUpDebouncer = new rxjs.Subject();
            return _this;
        }
        TextareaComponent_1 = TextareaComponent;
        TextareaComponent.prototype.ngOnInit = function () {
            var _this = this;
            this.keyUpDebouncer.pipe(operators.throttleTime(300)).subscribe(function (text) { return _this.updateTextareaSize(text); });
        };
    ...
    var PasswordInputComponent = /** @class */ (function () {
        ...
        Object.defineProperty(PasswordInputComponent.prototype, "withRules", {
            ...
            set: function (value) { this._withRules = coercion.coerceBooleanProperty(value); },
            enumerable: true,
            configurable: true
        });
    ...
    var ToastModel = /** @class */ (function () {
        function ToastModel(data) {
            ...
            if (this.buttons.length > 0) {
                this.onClick = new rxjs.BehaviorSubject('');
            }
        }
        return ToastModel;
    }());
    ...
    var ToastComponent = /** @class */ (function () {
        ...
        __decorate([
            core.ViewChild('toastContainer', { static: true }),
            __metadata("design:type", core.ElementRef)
    ...
    var ToasterModule = /** @class */ (function () {
        ...
        ToasterModule = __decorate([
            core.NgModule({
                imports: [common.CommonModule, TranslateModule, TooltipModule, ButtonModule, SvgModule],
    ...
    var Toaster = /** @class */ (function () {
        ...
        Toaster.ɵprov = core["ɵɵdefineInjectable"]({ factory: function Toaster_Factory() { return new Toaster(core["ɵɵinject"](core.ComponentFactoryResolver)); }, token: Toaster, providedIn: "root" });
        Toaster = __decorate([
            core.Injectable({
                providedIn: 'root'
            }),
    ...
    var ExpandListComponent = /** @class */ (function () {
        ...
        Object.defineProperty(ExpandListComponent.prototype, "large", {
            ...
            set: function (value) { this._large = coercion.coerceBooleanProperty(value); },
            enumerable: true,
            configurable: true
        });
    ...
    var ExpandTitleDirective = /** @class */ (function () {
        ...
        ExpandTitleDirective = __decorate([
            core.Directive({ selector: 'expand-title' })
    ...
    var ExpandDescriptionDirective = /** @class */ (function () {
        ...
        ExpandDescriptionDirective = __decorate([
            core.Directive({ selector: 'expand-description' })
    ...
    var PaginationComponent = /** @class */ (function () {
        function PaginationComponent() {
            ...
            this.page = 0;
            this.pageSize = 20;
            this.goTo = new core.EventEmitter();
            this.pages = [];
        }
    ...
    var SidebarComponent = /** @class */ (function () {
        function SidebarComponent(elementRef, sidebarService, renderer, cdr) {
            ...
            this.openedChanged = new core.EventEmitter();
            this.foldedChanged = new core.EventEmitter();
            this.isOpen = false;
        ...
        Object.defineProperty(SidebarComponent.prototype, "unfoldOnHover", {
            ...
            set: function (value) { this._unfoldOnHover = coercion.coerceBooleanProperty(value); },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(SidebarComponent.prototype, "noBackdrop", {
            get: function () { return this._noBackdrop; },
            set: function (value) { this._noBackdrop = coercion.coerceBooleanProperty(value); },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(SidebarComponent.prototype, "foldedWidth", {
            get: function () { return this._foldedWidth; },
            set: function (value) { this._foldedWidth = coercion.coerceNumberProperty(value); },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(SidebarComponent.prototype, "folded", {
            ...
            set: function (value) {
                this._folded = coercion.coerceBooleanProperty(value);
        ...
        Object.defineProperty(SidebarComponent.prototype, "lockedOpen", {
            ...
            set: function (value) {
                this._lockedOpen = coercion.coerceBooleanProperty(value);
                if (this._lockedOpen) {
                    this.open();
                }
            },
        ...
        __decorate([
            core.HostBinding('class.locked-opened'),
            __metadata("design:type", Object)
        ...
        __decorate([
            core.HostBinding('class.animations-enabled'),
            __metadata("design:type", Object)
    ...
    var CalendarComponent = /** @class */ (function () {
        function CalendarComponent(service) {
            ...
            this.calendarViews = exports.CalendarView;
            this.view = exports.CalendarView.day;
            this.legend = '';
            this.refDate = new Date();
        }
        Object.defineProperty(CalendarComponent.prototype, "rangeStart", {
            set: function (value) {
                this._isRangeStart = coercion.coerceBooleanProperty(value);
        ...
        Object.defineProperty(CalendarComponent.prototype, "rangeEnd", {
            set: function (value) {
                this._isRangeEnd = coercion.coerceBooleanProperty(value);
                if (this._isRangeEnd) {
        ...
        Object.defineProperty(CalendarComponent.prototype, "noFuture", {
            set: function (value) { this._noFuture = coercion.coerceBooleanProperty(value); },
            enumerable: true,
            configurable: true
        });
        ...
        CalendarComponent.prototype.goToPrevious = function () {
            ...
            if (this.view === exports.CalendarView.year) {
                this.calendar = this.service.getPreviousYears(this.calendar.dateRef, ref, this._min);
            }
            else if (this.view === exports.CalendarView.month) {
        ...
        CalendarComponent.prototype.selectDate = function (selection) {
            var ref = this._selection && this._selection.start ? this._selection.start : this.refDate;
            if (this.view === exports.CalendarView.year) {
                this.view = exports.CalendarView.month;
    ...
    var DatePickerComponent = /** @class */ (function (_super) {
        ...
        Object.defineProperty(DatePickerComponent.prototype, "rangeStart", {
            set: function (value) {
                this._rangeStart = coercion.coerceBooleanProperty(value);
        ...
        Object.defineProperty(DatePickerComponent.prototype, "rangeEnd", {
            set: function (value) {
                this._rangeEnd = coercion.coerceBooleanProperty(value);
        ...
        Object.defineProperty(DatePickerComponent.prototype, "dontCloseOnSelection", {
            set: function (value) { this._dontCloseOnSelection = coercion.coerceBooleanProperty(value); },
            enumerable: true,
            configurable: true
        });
    ...
    var PopupDirective = /** @class */ (function () {
        ...
        Object.defineProperty(PopupDirective.prototype, "popupOnRight", {
            set: function (value) { this._popupOnRight = coercion.coerceBooleanProperty(value); },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(PopupDirective.prototype, "openedFromPopup", {
            set: function (value) { this._openedFromPopup = coercion.coerceBooleanProperty(value); },
            enumerable: true,
            configurable: true
        });
    ...
    var DateInputComponent = /** @class */ (function (_super) {
        ...
        DateInputComponent.prototype.selectDate = function (date) {
            ...
            this.dateInput = dateFns.isToday(date) ? 'Today' : dateFns.isYesterday(date) ? 'Yesterday' : dateFns.format(date, 'MM/dd/yyyy');
            markForCheck(this.cdr);
        ...
        DateInputComponent.prototype.checkTypedDate = function (date) {
            ...
            if (date !== '') {
                ...
                if (date.toLowerCase() === 'today') {
                    ...
                    this.currentDate = dateFns.startOfYesterday();
                }
                else {
                    this.isValidDate = date.length >= 8 && dateFns.isValid(typedDate);
                    if (this.isValidDate) {
                        ...
                        if (brokenDate[0] === '2' || brokenDate[0] === '02') {
                            ...
                            this.isValidDate = dateFns.getMonth(typedDate) === 1;
                        }
                    }
                    if (this.isValidDate) {
        ...
        __decorate([
            core.ViewChild('datePickerPopup'),
            __metadata("design:type", Object)
    ...
    var DropdownItemComponent = /** @class */ (function () {
        function DropdownItemComponent(service) {
            ...
            this.onSelection = new core.EventEmitter();
            this.onSubMenuSelection = new core.EventEmitter();
            this._iconName = '';
            this.subMenuOpen = false;
            this.terminator = new rxjs.Subject();
            this.service.closeAllSubMenu.pipe(operators.takeUntil(this.terminator)).subscribe(function () { return _this.subMenuOpen = false; });
        }
        ...
        Object.defineProperty(DropdownItemComponent.prototype, "smallIcon", {
            set: function (value) { this.isSmallIcon = coercion.coerceBooleanProperty(value); },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(DropdownItemComponent.prototype, "iconOnRight", {
            set: function (value) { this.isIconOnRight = coercion.coerceBooleanProperty(value); },
            enumerable: true,
            configurable: true
        });
        ...
        __decorate([
            core.ViewChild(DropdownComponent, { static: true }),
    ...
    var DropdownCheckboxComponent = /** @class */ (function () {
        ...
        Object.defineProperty(DropdownCheckboxComponent.prototype, "disabled", {
            set: function (value) { this.isDisabled = coercion.coerceBooleanProperty(value); },
            enumerable: true,
            configurable: true
        });
        ...
        __decorate([
            core.ViewChild('menuRef', { read: PopupDirective }),
    ...
    exports.DropdownCheckboxComponent = DropdownCheckboxComponent;
    exports.DropdownItemComponent = DropdownItemComponent;
    exports.DropdownModule = DropdownModule;
    exports.DropdownSectionComponent = DropdownSectionComponent;
    exports.DropdownSeparatorComponent = DropdownSeparatorComponent;
    exports.ExpandComponent = ExpandComponent;
    exports.ExpandDescriptionDirective = ExpandDescriptionDirective;
    exports.ExpandModule = ExpandModule;
    exports.ExpandTitleDirective = ExpandTitleDirective;
    exports.FakeSvgLoader = FakeSvgLoader;
    exports.Icon = Icon;
    ...
    exports.PastanagaProgressComponent = PastanagaProgressComponent;
    exports.PastanagaService = PastanagaService;
    ...
    exports.TextfieldCommon = TextfieldCommon;
    exports.ToastButtonModel = ToastButtonModel;
    exports.ToastComponent = ToastComponent;
    exports.ToastModel = ToastModel;
    exports.Toaster = Toaster;
    exports.ToasterModule = ToasterModule;
    exports.ToggleComponent = ToggleComponent;
    exports.ToggleDivider = ToggleDivider;
    exports.ToggleGroupComponent = ToggleGroupComponent;
    ...
    exports.getFixedRootParent = getFixedRootParent;
    exports.getPositionnedParent = getPositionnedParent;
    exports.getRealPosition = getRealPosition;
    exports.getToastCloseButton = getToastCloseButton;
    exports.getVirtualScrollParentPosition = getVirtualScrollParentPosition;
    exports.markForCheck = markForCheck;
    exports.svgLoaderFactory = svgLoaderFactory;
    exports.ɵa = ButtonBase;
    exports.ɵb = PastanagaSpinnerComponent;
    exports.ɵc = PastanagaProgressCircleComponent;
    exports.ɵd = InputIconComponent;
    exports.ɵe = TextareaComponent;
    exports.ɵf = PasswordInputComponent;
    exports.ɵg = ExpandListComponent;
    exports.ɵh = DateInputComponent;
    exports.ɵi = DropdownComponent;

    Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=guillotinaweb-pastanaga-angular.umd.js.map
